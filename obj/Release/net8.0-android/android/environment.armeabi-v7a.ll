...
@dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 122049240, ; hash 0x74652d8, from name: aot-Syncfusion.Maui.Expander.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 179457679, ; hash 0xab24e8f, from name: Syncfusion.Maui.Expander
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.34_name, ; name: libaot-Syncfusion.Maui.Expander.dll.so
		ptr null; void* handle (0x0)
	}, ; 28
	...
	%struct.DSOCacheEntry {
		i64 653887548, ; hash 0x26f9883c, from name: DigesettAPP.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 837217792, ; hash 0x31e6ee00, from name: aot-Syncfusion.Maui.Expander
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.34_name, ; name: libaot-Syncfusion.Maui.Expander.dll.so
		ptr null; void* handle (0x0)
	}, ; 131
	...
	%struct.DSOCacheEntry {
		i64 1028495646, ; hash 0x3d4d991e, from name: libaot-DigesettAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DigesettAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 172
	...
	%struct.DSOCacheEntry {
		i64 1828327463, ; hash 0x6cfa1027, from name: DigesettAPP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DigesettAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 308
	...
	%struct.DSOCacheEntry {
		i64 1854657678, ; hash 0x6e8bd48e, from name: aot-DigesettAPP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DigesettAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 311
	...
	%struct.DSOCacheEntry {
		i64 2073992783, ; hash 0x7b9e9e4f, from name: libaot-Syncfusion.Maui.Expander.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.34_name, ; name: libaot-Syncfusion.Maui.Expander.dll.so
		ptr null; void* handle (0x0)
	}, ; 355
	...
	%struct.DSOCacheEntry {
		i64 3076978509, ; hash 0xb766f74d, from name: Syncfusion.Maui.Expander.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.34_name, ; name: libaot-Syncfusion.Maui.Expander.dll.so
		ptr null; void* handle (0x0)
	}, ; 553
	...
	%struct.DSOCacheEntry {
		i64 3177606762, ; hash 0xbd666e6a, from name: aot-DigesettAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DigesettAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 572
	...
	%struct.DSOCacheEntry {
		i64 3565937488, ; hash 0xd48be350, from name: libaot-DigesettAPP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DigesettAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 634
	...
	%struct.DSOCacheEntry {
		i64 3854398492, ; hash 0xe5bd741c, from name: libaot-Syncfusion.Maui.Expander
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.34_name, ; name: libaot-Syncfusion.Maui.Expander.dll.so
		ptr null; void* handle (0x0)
	}, ; 682
